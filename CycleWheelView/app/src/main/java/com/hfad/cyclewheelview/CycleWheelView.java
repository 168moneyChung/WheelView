package com.hfad.cyclewheelview;
...
public class CycleWheelView extends ListView
{
    ...
    /**
     * 如果需要自訂義滾輪每個 Item，呼叫此方法設置自訂義 Item 布局，自訂義布局需要一個 TextView 來顯示滾輪刻度
     * @param itemResId 布局文件 id
     * @param labelTvId 刻度 TextView 的資源Id
     */
    ...
    /**
     * 設置滾輪可顯示的刻度數量，必須為奇數，且大於等於3
     * @param wheelSize
     * @throws CycleWheelViewException 滾輪數量錯誤
     */
    ...
    /**
     * 設置區域顏色
     * @param unselectedSolidColor 未選中的區域顏色
     * @param selectedSolidColor 選中的區域顏色
     */
